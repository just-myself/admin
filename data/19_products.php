...
//获取总记录数
$sql = "SELECT COUNT(*) FROM xz_index_product WHERE 1=1 ";
if($kw){
  $kw = urldecode($kw);
...
$sql =  "SELECT pid,title,details,pic,price";
$sql .= " ,seq_recommended,seq_new_arrival,seq_top_sale,expire";
$sql .= " FROM xz_index_product";
